...
//Template
export const TEMPLATE_SEND_COMMAND_IMPLEMENTATION = path.join(WEB, "src", "templates", "sensact",  "sendCommandImplementation.template.ts");
export const TEMPLATE_SENSACT_APPS =                path.join(WEB, "src", "templates", "sensact",  "sensactapps.template.ts");
